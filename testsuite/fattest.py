...
# It has to be preprocessed by CMake to find path of test image
    testFile = '/home/vertrex/dffpro/testsuite/dftt/5-fat-daylight.zip'
    vfsTestFilePath = '/5-fat-daylight.zip/5-fat-daylight/daylight.dd'
    expectedLoadOutput = '/home/vertrex/dffpro/testsuite/results/fattest.5-fat-daylight.load.txt'
    expectedListOutput = '/home/vertrex/dffpro/testsuite/results/fattest.5-fat-daylight.ls.txt'
    expectedListAccurateOutput = '/home/vertrex/dffpro/testsuite/results/fattest.5-fat-daylight.ls_accurate.txt'
